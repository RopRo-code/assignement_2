...
# Task no 1
def function1(start,end,Row,column):
    # create 2d array from 1,12 range 
    # dimension should be 6row 2 columns  
    # and assign this array values in x values in x variable
    # Hint: you can use arange and reshape numpy methods  
    x =  np.arange(start,end).reshape((Row,column)) 
    return x
...
# Task2
def function2(start,end,D1,D2,D3):
    #create 3D array (3,3,3)
    #must data type should have float64
    #array value should be satart from 10 and end with 36 (both included)
    # Hint: dtype, reshape 
    
    x = np.arange(start,end,dtype=np.float64).reshape((D1,D2,D3))    #wrtie your code here


    return x
function2(1,28,3,3,3)
    """
    Expected: out put
array([[[10., 11., 12.],
        [13., 14., 15.],
...
def function8():
    ...
    x = np.ones([3, 5], dtype=np.uint) *6 #write your code here
...
def function11():
    ...
    ans = np.where(arr%2==1,-1,0) #write your code here 
...
def function17():
    ...
    return arr[np.where(arr%3 & arr%5,'YES','NO')].astype(np.str)          # Write Your Code HERE
...
def function19():
    ...
    X = np.arange(1,25).reshape(5,5)   # Write your code here
